                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select" id="cuenta_bancaria_id" name="cuenta_bancaria_id" {{ $compra->tipo == 'contado' ? 'required' : '' }}>
                                        <option value="">Seleccione cuenta</option>
                                        @foreach($cuentasBancarias as $cuenta)
                                            <option value="{{ $cuenta->id }}" {{ $compra->pagos->first()?->cuenta_bancaria_id == $cuenta->id ? 'selected' : '' }}>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    tipoSelect.addEventListener('change', function() {
        ...
        cuentaBancariaSelect.required = esContado;
    });
