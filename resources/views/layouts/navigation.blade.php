...
<nav id="sidebar" class="sidebar">
    ...
    <div class="sidebar-menu">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('filtrado.*') ? 'active' : '' }}" 
                   href="{{ route('filtrado.index') }}">
                    ...
                    <span class="menu-text">Filtrado</span>
                </a>
            </li>
            @endcan

            <!-- Inventario -->
            @canany(['ver-materias-primas', 'ver-productos', 'ver-inventario'])
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('materia-prima-sin-filtrar.*') || request()->routeIs('materia-prima-filtrada.*') || request()->routeIs('productos.*') ? 'active' : '' }}" 
                ...
                <div class="collapse {{ request()->routeIs('materia-prima-sin-filtrar.*') || request()->routeIs('materia-prima-filtrada.*') || request()->routeIs('productos.*') ? 'show' : '' }}" id="inventarioSubmenu">
            ...
            <!-- Ventas -->
            @canany(['ver-ventas', 'ver-clientes'])
            <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <div class="collapse {{ request()->routeIs('compras.*') ? 'show' : '' }}" id="comprasSubmenu">
                    <ul class="nav flex-column submenu">
                        @can('ver-compras')
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('compras.*') ? 'active' : '' }}" 
            ...
            <!-- Finanzas -->
            @canany(['ver-cuentas-bancarias', 'ver-movimientos-bancarios'])
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('cuentas-bancarias.*') || request()->routeIs('cierre.*') || request()->routeIs('reporte.flujo-caja') ? 'active' : '' }}" 
                ...
                <div class="collapse {{ request()->routeIs('cuentas-bancarias.*') || request()->routeIs('cierre.*') || request()->routeIs('reporte.flujo-caja') ? 'show' : '' }}" id="finanzasSubmenu">
                    <ul class="nav flex-column submenu">
                        @can('ver-cuentas-bancarias')
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('cuentas-bancarias.*') ? 'active' : '' }}" 
            ...
            <li class="nav-item">
                ...
                <div class="collapse {{ request()->routeIs('reportes.*') ? 'show' : '' }}" id="reportesSubmenu">
                    <ul class="nav flex-column submenu">
                        <li class="nav-item">
